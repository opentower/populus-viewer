...
render(props,state) {
    return ( 
      <Fragment>
        ...
        <div class="inner">{this.props.total > this.props.page ? <label class="navbutton arrowact" type="button" onclick={_ => props.loadPage(this.props.page + 1)}>&rsaquo;</label> : <label type="button" class="navbutton arrowinact">&rsaquo;</label>}</div>
